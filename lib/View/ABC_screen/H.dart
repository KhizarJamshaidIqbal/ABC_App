...
import 'package:damo/View/ABC_screen/I.dart';
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(top: 250.0, left: 410),
            child: GradientText(
              'For',
              style:
          ...
          Positioned(
              ...
              child: SizedBox(
                  height: 300,
                  width: 250,
                  child: Lottie.asset('Images/Halicoptr.json'))),
              Padding(
            padding: const EdgeInsets.only(top: 260.0, left: 510),
            child: GradientText(
              'Helicopter',
