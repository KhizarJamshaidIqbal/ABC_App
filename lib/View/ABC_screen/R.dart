...
import 'package:damo/View/ABC_screen/P.dart';
import 'package:damo/View/ABC_screen/S.dart';
        ...
        children: [
          ...
          Positioned(
              ...
              child: SizedBox(
                  height: 450,
                  width: 300,
                  child: Lottie.asset('Images/rabbit.json'))),
              // ignore: prefer_const_constructors
              Padding(
            padding: const EdgeInsets.only(top: 260.0, left: 550),
            // ignore: prefer_const_constructors
            child: GradientText(
              'Rabbit',
