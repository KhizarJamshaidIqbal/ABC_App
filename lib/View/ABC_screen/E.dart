...
import 'package:damo/View/ABC_screen/D.dart';
import 'package:damo/View/ABC_screen/F.dart';
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(top: 250.0, left: 405),
            child: GradientText(
              'For',
              style:
          ...
          Positioned(
              ...
              child: SizedBox(
                  height: 450,
                  width: 300,
                  child: Lottie.asset('Images/Elephant.json'))),
              Padding(
            padding: const EdgeInsets.only(top: 260.0, left: 530),
            child: GradientText(
              'Elephant',
